...
Let each trial have a chance of success $p=`r p`$. If `r n` trials occur, what is the probability of getting at least `r ks[1]` but at most `r ks[2]` successes? 

In other words, let $X\sim \text{Bin}(n=`r n`,\,p=`r p`)$ and find $P(`r ks[1]`\le X \le`r ks[2]`)$.
