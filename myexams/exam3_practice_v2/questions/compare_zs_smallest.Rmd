...
Yasmine took 4 exams for her statistics class. Each exam yielded normally distributed scores (the class's scores were normally distributed). Yasmine's scores and the exams' means and standard deviations are shown below.

\begin{center}
\begin{tabular}{|c|c|c|c|}\hline
Exam & Yasmine's score & Mean of all scores & SD of all scores \\ \hline
