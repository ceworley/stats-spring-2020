...
s7 = c(paste("$P(\\text{",cs[c7]," given ",is[i7[1]],"}) = ",p7[1],"$ and $P(\\text{",cs[c7]," given  ",is[i7[2]],"}) = ",p7[2],"$, so a ",big," is more likely to be ",cs[c7]," than a ",small," is.",sep=""),"")

ts = list(t1,t2,t3,t4,t5,t6,t7)
sss = list(s1,s2,s3,s4,s5,s6,s7)
types = c(rep("num",6),"schoice")
sols = c(p1,p2,p3,p4,p5,p6,sol7)
ord = sample(1:7)
