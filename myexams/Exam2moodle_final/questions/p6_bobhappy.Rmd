...
Question
========
Bob has a `r p1*100`% chance of winning a game. If Bob wins, he has a `r p2*100`% chance of being happy. If Bob loses, he has a `r p3*100`% chance of being happy. 

After his game, you notice Bob is happy. What is the probability that Bob won his game? (Do not answer as a percentage; answer as a decimal.)
