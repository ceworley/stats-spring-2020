...
We can approximate a 95% confidence interval of a **proportion** (where the 95% refers to how frequently the true population proportion lands inside these intervals) by using $\hat{p} \pm \frac{2 \sqrt{\hat{p}(1-\hat{p})}}{\sqrt{n}}$.
