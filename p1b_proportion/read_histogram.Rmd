...
Answerlist
--------
* There are `r n1` measurements less than `r b1`. So, $\text{prop}[\mathbf{x}<`r b1`]=`r n1/n`$.
* There are `r n2` measurements more than `r b2`. So, $\text{prop}[\mathbf{x}>`r b2`]=`r n2/n`$.
* There are `r n3` measurements closer than `r r3` units from `r c3`. So, $\text{prop}[|\mathbf{x}-`r c3`|<`r r3`]=`r n3/n`$.
* There are `r n4` measurements further than `r r4` units from `r c4`. So, $\text{prop}[|\mathbf{x}-`r c4`|>`r r4`]=`r n4/n`$.
* A boundary at $b=`r b5`$ has `r n5` measurements less than it. So, $\text{prop}[\mathbf{x}<`r b5`]=`r n5/n`$.
* A boundary at $b=`r b6`$ has `r n6` measurements more than it. So, $\text{prop}[\mathbf{x}>`r b6`]=`r n6/n`$.
