...
That spinner will be spun `r n` times, and the **sample mean** of those rolls will be recorded. What is the probability the sample mean will be **less** than `r sprintf('%.2f',xa)`?
