...
That spinner will be spun `r n` times, and the **sample mean** of those rolls will be recorded. What is the probability the sample mean will be **within** `r sprintf('%.2f',d)` units from the expected value?
...
$$P\left(\left|\bar{X}-`r mua`\right| < `r d` \right) ~=~ P(|Z|<`r z`) ~=~ `r ca` $$
