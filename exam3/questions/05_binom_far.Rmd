...
That spinner will be spun `r n` times. What is the probability the number of successes will be **outside** `r sprintf('%.1f',d)` units from the expected value?
