...
The density curve can be used by counting percent boxes. Each box adds 0.01 to the proportion. You may need to count half boxes, or find partial boxes that add to whole boxes.
```{r echo=F, fig.width=6, fig.height=4.5}
x = seq(bottom,bottom+width,length.out=1000)
