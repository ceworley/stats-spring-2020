...
Answerlist
--------
* Evaluate $d$ such that $P\left(\big|`r Xl`-`r mu`\big|>d\right) = `r ta`$.
* Evaluate $`r xl`_1$ such that $`r xl`_1 = `r mu`-d$.
* Evaluate $`r xl`_2$ such that $`r xl`_2 = `r mu`+d$.
