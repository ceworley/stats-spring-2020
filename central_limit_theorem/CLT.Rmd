...
The random variable $\sum X$ and is approximately normal with mean $n\mu_{\tiny X}$ and standard deviation $\sigma_{\tiny X} \sqrt{n}$. 
...
The random variable $\bar X$ and is approximately normal with mean $\mu_{\tiny X}$ and standard deviation $\frac{\sigma_{\tiny X}}{\sqrt{n}}$. 
